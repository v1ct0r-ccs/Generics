...
import Cadastro.dao.Cliente.ClienteMapDAO;
import Cadastro.dao.Cliente.IClienteDAO;
import Cadastro.dao.Produto.IProdutoDAO;
import Cadastro.dao.Produto.ProdutoDAO;
...
public class App extends Component {
    ...
    // **** Tela Cliente ****
    private static void exibirTelaCadastroCliente() {
    ...
    private static void cadastrarProduto(String dados) {
        ...
        try {
            ...
            Produto produto = new Produto(codigo, nome, preco, quant);
